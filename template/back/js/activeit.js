...
!function ($) {
	...
	$.activeitNoty = function(options){
		...
		template = function(){
			...
			if (!opt.html) {
				return defTemplate + iconTemplate() + '<div class="media-body"><h4 class="alert-title">'+ opt.title +'</h4><p class="alert-message">'+ 'Modification is disabled in demo!' +'</p></div></div>';
			}
