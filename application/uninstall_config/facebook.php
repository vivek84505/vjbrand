...
$config['facebook_app_id']              = $CI->db->get_where('third_party_settings',array('type'=>'fb_appid'))->row()->value;;
$config['facebook_app_secret']          = $CI->db->get_where('third_party_settings',array('type'=>'fb_secret'))->row()->value;;
