            ...
            <tbody >
                ...
                foreach ($all_langss as $row) {
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a class="btn btn-primary btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                               onclick="ajax_set_full('lang_select', '<?php echo translate('edit_language_list'); ?>', '<?php echo translate('successfully_edited!'); ?>', 'language_list_edit', '<?php echo $row['db_field']; ?>');
                                       proceed('to_list');" 
