    ...
    <div class="col-md-12">
        ...
        <div class="panel-body">
            ...
            <div class="form-group btm_border">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Crud_model->select_html('news_category', 'news_category', 'name', 'add', 'demo-chosen-select required', '', '', '', 'get_cat') ?>
                </div>
            </div>
            ...
            <div class="form-group btm_border">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Crud_model->select_html('news_reporter', 'news_reporter', 'name', 'add', 'demo-chosen-select required', '', '', '', '') ?>
                </div>
            </div>
            <div class="form-group btm_border">
                <label class="col-sm-2 control-label">
                ...
                <div class="col-sm-10" id="latest_news">
            ...
            <div class="form-group btm_border">
                ...
                <div class="col-sm-10" id="breaking_news">
        ...
        <div class="panel-footer">
            <div class="row">
                ...
                <div class="col-md-1" style="margin-left:1%">
                    <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('news_add', '<?php echo translate('successfully_added!'); ?>'); proceed('to_add');" >
...
<script>
    function get_cat(id) {
        ajax_load(base_url + 'admin/news/sub_by_cat/' + id, 'sub_cat_name', 'other');
        //$('#sub_cat').show();
    }
    function save_draft() {
        $('#status').val('not_published');
        setTimeout(form_submit('news_add', '<?php echo translate('successfully_added!'); ?>'), 500);
    }
