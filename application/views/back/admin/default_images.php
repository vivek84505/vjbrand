        ...
        <div class="panel">
            <div class="tab-base tab-stacked-left">
                <ul class="nav nav-tabs">
                    <?php
                    $i = 0;
                    foreach ($default_list as $row => $name) {
                        $i++;
                        ?>
                        <li <?php if ($i == 1) { ?>class="active"<?php } ?> >
                            <a data-toggle="tab" href="#<?php echo $row; ?>"><?php echo translate($name); ?></a>
                        </li>
                        <?php
                    }
                    ?>
                        ...
                        <div id="<?php echo $row; ?>" class="tab-pane fade <?php if ($i == 1) { ?>active in<?php } ?>">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo translate($name); ?></h3>
                                </div>
                                <?php
                                            ...
                                            <div class="col-sm-6 col-sm-offset-3">
                                                <center>
                                                    ...
                                                    if (file_exists('uploads/' . $row . '/default.jpg')) {
                                                        ...
                                                        ?>
                                                             <img class="img-responsive img-border blah" style="width:50%;height:40%" src="<?php echo base_url(); ?>uploads/others/default_image.png">
                                                             <?php
                                                         }
                                                         ?>
                                                    <br />
