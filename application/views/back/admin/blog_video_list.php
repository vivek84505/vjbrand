        ...
        <tbody >
            ...
            foreach ($all_videos as $row) {
                ...
                <tr>
                    ...
                    <td>
                        <?php if($row['blog_video_uploader_type'] == 'admin') { echo translate('admin'); } else { echo translate('user'); }  ?>
                    </td>
                    <td>
            ...
            <center>
                <input class='aiz_switchery' type="checkbox" id="sw"
                       data-set='status'
                       data-id='<?php echo $row['blog_video_id']; ?>'
            ...
            <center>
                <a class="btn btn-info btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip"
                   onclick="ajax_set_full('edit', '<?php echo translate('edit_video'); ?>', '<?php echo translate('successfully_edited!'); ?>', 'blog_video_edit', '<?php echo $row['blog_video_id']; ?>', proceed('to_list'))" data-original-title="Edit" data-container="body">
                       <?php echo translate('edit'); ?>
                </a>

                <a onclick="delete_confirm('<?php echo $row['blog_video_id']; ?>', '<?php echo translate('really_want_to_delete_this?'); ?>')"
