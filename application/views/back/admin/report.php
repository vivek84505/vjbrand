...
<div id="content-container">
    <div id="page-title">
        <h1 class="page-header text-overflow"><?php echo translate('category_wise_news'); ?></h1>
    </div>
    <div class="tab-base">
        <div class="panel">
                ...
                ?>
                    {
                        ...
                        "visits": <?php echo $this->db->get_where('news', array('news_category_id' => $row['news_category_id']))->num_rows(); ?>,
                        "color": "#99BDF9"
                    },
                <?php
                    }
