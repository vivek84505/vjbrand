    ...
    <div class="col-md-12">
        ...
        foreach ($video_data as $row) {
            ...
            <div class="tab-pane fade active in" id="edit">
                <?php
                echo form_open(base_url() . 'admin/blog_video/update/' . $row['blog_video_id'], array(
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right"
                                  onclick="ajax_set_full('edit', '<?php echo translate('edit_video'); ?>', '<?php echo translate('successfully_edited!'); ?>', 'blog_video_edit', '<?php echo $row['blog_video_id']; ?>')"><?php echo translate('reset'); ?>
                            </span>
                        </div>
                        <div class="col-md-1">
                            <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right enterer" onclick="form_submit('blog_video_edit', '<?php echo translate('successfully_edited!'); ?>');
