                            ...
                            <div class="row" style="padding:5px;">
                                ...
                                if ($from1['type'] == 'admin') {
                                    ...
                                    <img <?php if (file_exists('uploads/user_image/user_' . $from1['id'] . '.jpg')) { ?>
                                        ...
                                        <?php } else if ($this->db->get_where('user', array('user_id' => $from1['id']))->row()->facebook !== '') { ?>
                                            src="https://graph.facebook.com/<?php echo $this->db->get_where('user', array('user_id' => $from1['id']))->row()->facebook; ?>/picture?type=large" 
                                        <?php } else { ?>
                            ...
                            <div class="row">
                                <b><i>
                                        ...
                                        if ($from1['type'] == 'admin') {
                                            ...
                                            echo $this->Crud_model->get_type_name_by_id('user', $from['id'], 'firstname');
                                        }
                                        ?>
                                    </i></b>
                            </div>
