        ...
        <div class="panel">
            <div class="tab-base tab-stacked-left">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-3"><?php echo translate('news_comment_settings'); ?></a>
                    </li>
                    <li>
                ...
                <div class="tab-content bg_grey">
                    ...
                    <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
                        <div class="col-md-12">
                            <div class="panel">
                                ...
                                <?php $cpub = $this->db->get_where('third_party_settings', array('type' => 'captcha_public'))->row()->value; ?>
                                <?php $cprv = $this->db->get_where('third_party_settings', array('type' => 'captcha_private'))->row()->value; ?>
                                <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="captcha_status" class='sw4' data-set='captcha_status' type="checkbox" <?php if ($this->Crud_model->get_settings_value('third_party_settings', 'captcha_status', 'value') == 'ok') { ?>checked<?php } ?> />
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div id="demo-stk-lft-tab-2" class="tab-pane fade">
                        <div class="col-md-12">
                            <div class="panel">
                                ...
                                $application_name = $this->db->get_where('third_party_settings', array('type' => 'g_application_name'))->row()->value;
                                $client_id = $this->db->get_where('third_party_settings', array('type' => 'g_client_id'))->row()->value;
                                $client_secret = $this->db->get_where('third_party_settings', array('type' => 'g_client_secret'))->row()->value;
                                $redirect_uri = $this->db->get_where('third_party_settings', array('type' => 'g_redirect_uri'))->row()->value;
                                $g_api_key = $this->db->get_where('third_party_settings', array('type' => 'g_api_key'))->row()->value;
                                $fb_login_set = $this->db->get_where('third_party_settings', array('type' => 'fb_login_set'))->row()->value;
                                $g_login_set = $this->db->get_where('third_party_settings', array('type' => 'g_login_set'))->row()->value;
                                ?>
                                <?php
                                ...
                                <div class="form-group g_log_ins">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="col-sm-">
                                            <input type="text" name="g_api_key" value="<?php echo $g_api_key; ?>" class="form-control" >
                                        </div>
                                    </div>
                                </div>
                                <br />
                    ...
                    <div id="demo-stk-lft-tab-3" class="tab-pane fade">
                        <div class="col-md-12">
                            <div class="panel">
                                ...
                                ?>
                                <?php
                                echo form_open(base_url() . 'admin/news_comment/', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => '',
                                    'enctype' => 'multipart/form-data'
                                ...
                                ?>
                                <div class="panel-heading margin-bottom-15">
                                    <h3 class="panel-title"><?php echo translate('news_comment_settings'); ?></h3>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="demo-hor-inputemail">
                    ...
                    <div id="demo-stk-lft-tab-4" class="tab-pane fade">
                        <div class="col-md-12">
                            <div class="panel">
                                <?php
                                $api_key = $this->db->get_where('third_party_settings', array('type' => 'g_map_api_key'))->row()->value;
                                ?>
                                <?php
