        ...
        <div class="col-md-12">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="demo-hor-name"><b>Subscription Name</b></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="demo-hor-amount"><b>Amount (USD)</b></label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="amount" value="<?=$value->amount?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="post_amount"><b>Amount of Posts</b></label>
                    <div class="col-sm-9">
                        <input type="number" class="form-control" name="post_amount" value="<?=$value->post_amount?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="video_amount"><b>Amount of Videos</b></label>
                    <div class="col-sm-9">
                        <input type="number" class="form-control" name="video_amount" value="<?=$value->video_amount?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="photo_amount"><b>Amount of Images</b></label>
                    <div class="col-sm-9">
                        <input type="number" class="form-control" name="photo_amount" value="<?=$value->photo_amount?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="image"><b>Subscription Image</b></label>
                    <div class="col-sm-10">
