        ...
        <div class="panel">
            <div class="tab-base tab-stacked-left">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-7"><?php echo translate('blogs_social_links'); ?></a>
                    </li>
                    <li>
                   ...
                   <!--  <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-6">RSS</a>
                    </li> -->
                </ul>
                ...
                <div class="tab-content bg_grey">
                    ...
                    <!--Blog social links---------->
                    <div id="demo-stk-lft-tab-7" class="tab-pane fade <?php if ($tab_name == "blogs_social_links") { ?>active in<?php } ?>">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('blogs_social_links'); ?></h3>
                            </div>
                            <?php
                            echo form_open(base_url() . 'admin/blogs_social_links/set/', array(
                                'class' => 'form-horizontal',
                                'method' => 'post',
                                'id' => '',
                                'enctype' => 'multipart/form-data'
                                ...
                                <div class="form-group mar-btm">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group mar-btm">
                                            ...
                                            <input type="text" name="facebook" value="<?php echo $this->Crud_model->get_type_name_by_id('blogs_social_links', '1', 'value'); ?>" id="demo-hor-inputemail" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <!--G+---------->
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group mar-btm">
                                            ...
                                            <input type="text" name="google-plus" value="<?php echo $this->Crud_model->get_type_name_by_id('blogs_social_links', '2', 'value'); ?>" id="demo-hor-inputemail" class="form-control">
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group mar-btm">
                                            ...
                                            <input type="text" name="twitter" value="<?php echo $this->Crud_model->get_type_name_by_id('blogs_social_links', '3', 'value'); ?>" id="demo-hor-inputemail" class="form-control">
                                        </div>
                    ...
                    <!-- <div id="demo-stk-lft-tab-6" class="tab-pane fade">
                        <div class="panel">
                            ...
                            ?>
                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('RSS'); ?></h3>
                            </div>
                            <?php
