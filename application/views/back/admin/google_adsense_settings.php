<div id="content-container">
    <div id="page-title">
        <h1 class="page-header text-overflow">
            <?php echo translate('manage_google_adsense_settings') ?>
        </h1>
    </div>
    <div class="tab-base">
        <div class="panel">
            <div class="panel-heading">
                <h1 class="panel-title"><?php echo translate('page_wise_google_adsense_settings'); ?></h1>
            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tabo-1" class="tab-pane fade active in">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('header_1');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="tab-content">
                                                                <div id="tabb-1" class="tab-pane fade active in">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <?php
                                                                            $this->Ads_model->show_google_adsense_element('home_1');
                                                                            ?>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-md-12 form-horizontal">
                                                                            <?php
                                                                            $this->Ads_model->show_google_adsense_element('home_2');
                                                                            ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div id="tabb-7" class="tab-pane fade">
                                                                    <div class="row">
                                                                        <div class="col-md-12 form-horizontal">
                                                                            <?php
                                                                            $this->Ads_model->show_google_adsense_element('home_15');
                                                                            ?>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <?php
                                                                            $this->Ads_model->show_google_adsense_element('home_16');
                                                                            ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                ...
                                <div id="tabo-3" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('news_description_1');
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('news_description_2');
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('news_description_3');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div id="tabo-5" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('news_list_1');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div id="tabo-6" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('photo_gallery_1');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div id="tabo-7" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('photo_description_1');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div id="tabo-8" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('video_gallery_1');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div id="tabo-9" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('video_description_1');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div id="tabo-10" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('all_reporter_1');
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('all_reporter_2');
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('all_reporter_3');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div id="tabo-11" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('reporter_detail_1');
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('reporter_detail_2');
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('reporter_detail_3');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div id="tabo-12" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('archive_news_1');
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('archive_news_2');
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                            $this->Ads_model->show_google_adsense_element('archive_news_3');
                                            ?>
                                        </div>
                                    </div>
                                </div>
