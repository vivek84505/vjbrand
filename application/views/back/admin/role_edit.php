                                ...
                                foreach ($all_permissions as $row1) {
                                    if ($row1['parent_status'] == 'parent') {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input id="per_<?php echo $row1['permission_id']; ?>" class='sw2' type="checkbox" name="permission[]"  value="<?php echo $row1['permission_id']; ?>" data-id='<?php echo $row1['permission_id']; ?>' <?php
