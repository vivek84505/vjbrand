<div id="content-container">
    <div id="page-title">
        <h1 class="page-header text-overflow" >
            <?php echo translate('manage_video_gallery'); ?>
        </h1>
    </div>
    <div class="tab-base">
        <div class="panel">
                ...
                <div class="tab-content">
                    <div style="border-bottom: 1px solid #ebebeb;padding: 25px 5px 5px 5px;"
                        ...
                        <button class="btn btn-primary btn-labeled fa fa-plus-circle add_pro_btn pull-right" 
                                onclick="ajax_set_full('add', '<?php echo translate('add_video'); ?>', '<?php echo translate('successfully_added!'); ?>', 'video_add', ''); proceed('to_list');">
                                    <?php echo translate('create_video'); ?>
                        </button>
                        <button class="btn btn-info btn-labeled fa fa-step-backward pull-right pro_list_btn" 
                                style="display:none;"  onclick="ajax_set_list(); proceed('to_add');" >
                                    <?php echo translate('back_to_video_list'); ?>
                        </button>
                    </div>
                    <br>
