<div class="content">
    ...
    <div class="col-md-12" style="margin-top: 13px; padding: 0px 10px">
        <h2 class="block-title mar-t-10">
            <span id = 'profile_blog_title'><?php echo translate('latest_blogs'); ?></span>
        </h2>
        <div id="result">
            
        </div>
        <?php
            echo form_open(base_url() . 'home/ajax_blog_profile_list/', array(
        ...
        <?php
            echo form_open(base_url() . 'home/ajax_blog_profile_photo_list/', array(
                'class' => 'form-horizontal',
                'method' => 'post',
        ...
        <?php
            echo form_open(base_url() . 'home/ajax_blog_profile_video_list/', array(
                'class' => 'form-horizontal',
                'method' => 'post',
