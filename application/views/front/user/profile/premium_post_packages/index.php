        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php
                        echo form_open(base_url() . 'home/process_payment', array(
                            'method' => 'post',
                    ...
                    ?>
                        ...
                        <div class="row setup-content" id="step-2">
                            ...
                            <div class="col-md-12">
                                ...
                                <span id="btn_submit" class="button-custom-btn-1 submit_button enterer pull-right custom-btn-1-round-l custom-btn-1 custom-btn-1-text-thick custom-btn-1-text-upper custom-btn-1-size-s" data-text="<?php echo translate('submit'); ?>" style="display: none">
...
<script>
    ...
    function load_packages(package_id){
        var top = Number(200);
        $('.packages').html('<div style="text-align:center;width:100%;height:'+(top*2)+'px; position:relative;top:'+top+'px;"><i class="fa fa-refresh fa-spin fa-3x fa-fw"></i></div>');
        $('.packages').load('<?php echo base_url(); ?>home/profile/package/'+'/'+package_id);
    }
    ...
    function load_payments(){
        ...
        $('.payments-options').load('<?php echo base_url(); ?>home/profile/payment_options',
            function(){
