        ...
        <div class="package-body">
            ...
            <div class="package-details">
                <ul class="text-center">
                    <li><b>Amount of Posts:</b> <?=$value->post_amount?></li>
                    <li><b>Amount of Videos:</b> <?=$value->video_amount?></li>
                    <li><b>Amount of Images:</b> <?=$value->photo_amount?></li>
                    <li><b>Price:</b> $<?=$value->amount?></li>
                </ul>
            </div>
        </div>
