...
<?php if ($row['is_blogger'] == 'yes'): ?>
   <!--  <div class="information-title">
       <?php echo translate('package_information');?>
   </div>
   <div class="row">
           ...
           <div class="details-wrap">
               <div class="details-box orders">
                   <table class="table profile_info">
                       <tbody>
                           <tr>
                               <td class="description" width="40%">
                                   <?php echo translate('blog_post_amount');?>
                               </td>
                               <td width="1%">:</td>
                               <td align="center"> <?php echo $row['post_amount'];?> </td>
                           </tr>
                           <tr>
                               <td class="description" width="40%">
                                   <?php echo translate('blog_image_post_amount');?>
                               </td>
                               <td width="1%">:</td>
                               <td align="center"> <?php echo $row['photo_amount'];?> </td>
                           </tr>
                           <tr>
                               <td class="description" width="40%">
                                   <?php echo translate('blog_video_post_amount');?>
                               </td>
                               <td width="1%">:</td>
                               <td align="center"> <?php echo $row['video_amount'];?> </td>
                           </tr>
                       </tbody>
                   </table>
               </div>
