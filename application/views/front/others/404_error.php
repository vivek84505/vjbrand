...
<html lang="en">
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo base_url(); ?>template/front/assets/ico/apple-touch-icon-144-precomposed.png">
    ...
    <link href="<?php echo base_url(); ?>template/front/assets/css/theme-<?php echo $theme; ?>.css" rel="stylesheet" id="theme-config-link">
    <?php 
