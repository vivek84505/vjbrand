...
?>
    ...
    ?>
                <a href="<?php echo $row['url']; ?>" target="_blank">
                    <div class="img-bg img-responsive image_delay" style="height:95px;background-image: url(<?php echo img_loading(); ?>);" data-src="<?php echo base_url(); ?>uploads/default_banner/<?php echo $row['img']; ?>" alt="advertise"  ></div>
                </a>
    <?php
                    }
                }
