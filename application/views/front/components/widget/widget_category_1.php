<div class="widget shop-categories thin-border">
    ...
    <div class="widget-content">
        ...
        ?>
            <li>
                <a href="<?php echo base_url();?>home/category_news/<?php echo $row['news_category_id'];?>/0" onClick="get_news_list('<?php echo $row['news_category_id'];?>','0')" >
        ...
        ?>
            <li>
                ...
                <ul class="children">
                    ...
                    ?>
                    <li>
                        <a href="<?php echo base_url();?>home/category_news/<?php echo $row['news_category_id'];?>/<?php echo $rows['news_sub_category_id'];?>" onClick="get_news_list('<?php echo $row['news_category_id']; ?>','<?php echo $rows['news_sub_category_id'];?>');" > 
