<aside class="col-md-3 sidebar pull-left close_now pad-tb-5" id="sidebar">
    <div class="box_shadow">
       ...
       <div class="widget thin-border shop-categories">
            ...
            <div class="widget-content">
                <a href="https://www.facebook.com/" target="_blank" class="btn btn-block btn-primary btn-icon-left"><i class="fa fa-facebook"></i>Follow in Facebook</a>
                <a href="https://twitter.com/" target="_blank" class="btn btn-block btn-info btn-icon-left"><i class="fa fa-twitter"></i>Follow in Twitter</a>
                <a href="https://www.google.com/" target="_blank" class="btn btn-block btn-danger btn-icon-left"><i class="fa fa-google-plus"></i>Follow in Google+</a>
            </div>
        </div>
        <script>
            function vote_poll(){
