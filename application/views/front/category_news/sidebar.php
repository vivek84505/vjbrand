<!-- SIDEBAR -->
    <aside class="col-md-3 sidebar pull-<?php echo $category_news_data['sidebar']; ?>" id="sidebar">
    	<div class="box_shadow">
            ...
            <div class="advertise_space1">
                <div class="row">
                    <div class="col-md-12">
                    	<?php echo $this->Html_model->advertise_sqr('news_category_1'); ?>
                    </div>
                </div>
            </div>
            <!-- /advertisement space -->
            <?php
				$widgets = $category_news_data['widgets'];
