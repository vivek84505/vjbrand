<!-- SIDEBAR -->
    <aside class="col-md-3 sidebar pull-<?php echo $reporter_detail_page['sidebar']; ?>" id="sidebar">
    	<div class="box_shadow">
            ...
            <div class="advertise_space1">
                <div class="row">
                    <div class="col-md-12">
                    	<?php echo $this->Html_model->advertise_sqr('reporter_detail_1'); ?>
                    </div>
                </div>
            </div>
            <!-- /advertisement space -->
            <?php
				$widgets = $reporter_detail_page['widgets'];
