...
?>
	<input type="hidden" name="blog_category" id="blog_category" />
    <input type="hidden" name="blog_sub_category" id="blog_sub_category" />
...
function filter_blog(page){
	$('#blog_category').val($('#cur_cat').val());
	$('#blog_sub_category').val($('#cur_subcat').val());
