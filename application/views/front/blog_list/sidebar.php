<!-- SIDEBAR -->
    <aside class="col-lg-3 col-md-3 col-sm-12 col-xs-12 sidebar pull-<?php echo $listing_blog_data['sidebar']; ?>" id="sidebar">
    	<div class="box_shadow">
            <div class="widget thin-border shop-categories">
                <h4 class="widget-title">
                    <?php echo translate('blog_search');?>
            ...
            <div class="advertise_space1">
                <div class="row">
                    <div class="col-md-12">
                    	<?php echo $this->Html_model->advertise_sqr('blog_list_1'); ?>
                    </div>
                </div>
            </div>
            <!-- /advertisement space -->
            ...
            <?php
				$widgets = $listing_blog_data['widgets'];
...
<!-- /SIDEBAR -->
<input type="hidden" id="cur_cat" value="<?php echo $blog_category; ?>">
<input type="hidden" id="cur_subcat" value="<?php echo $blog_sub_category; ?>">
